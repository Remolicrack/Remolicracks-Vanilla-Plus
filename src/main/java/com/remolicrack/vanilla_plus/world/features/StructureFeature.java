package com.remolicrack.vanilla_plus.world.features;
...
import com.remolicrack.vanilla_plus.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.FEATURES, RemolicrackVanillaPlusMod.MODID);
