...
public abstract class CrimsonArmorItem extends ArmorItem {
	public CrimsonArmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(Blocks.CRIMSON_PLANKS));
			}
	...
	public static class Helmet extends CrimsonArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "remolicrack_vanilla_plus:textures/models/armor/crimson_layer_1.png";
		}
	}
	...
	public static class Leggings extends CrimsonArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "remolicrack_vanilla_plus:textures/models/armor/crimson_layer_2.png";
		}
	}
