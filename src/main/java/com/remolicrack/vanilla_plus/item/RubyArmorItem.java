...
public abstract class RubyArmorItem extends ArmorItem {
	public RubyArmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(RemolicrackVanillaPlusModItems.RUBY.get()));
			}
	...
	public static class Helmet extends RubyArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "remolicrack_vanilla_plus:textures/models/armor/ruby_layer_1.png";
		}
	...
	public static class Leggings extends RubyArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "remolicrack_vanilla_plus:textures/models/armor/ruby_layer_2.png";
		}
